...
from controllers.generic.probability_gap_model_evolution import run_model_evolution_report
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run settlement-aware probability-gap model evolution research.")
    parser.add_argument("--db-path", default=".yxg/data/probability_gap_samples_wu006_clean.sqlite")
